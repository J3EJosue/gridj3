...
const IconGithub = ({ size = 13, color = 'currentColor' }: IconProps) => (
  ...
  return (
    <>
      ...
      <div className="credit-footer">
        ...
        <a
          href="https://github.com/J3EJosue/gridj3"
          target="_blank"
          ...
          style={{
            ...
            fontSize: 10.5, fontWeight: 500, lineHeight: 1.6,
          }}
        >
          <IconGithub size={12} color="#fff" />
          J3eJosue/gridj3
        </a>
      </div>
    </>
